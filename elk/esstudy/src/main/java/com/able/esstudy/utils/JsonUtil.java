package com.able.esstudy.utils;
...
//        User user=new User();
//        user.setId(1);
//        user.setUsername("旗木卡卡西");
//        user.setQuestion("");
//        user.setCreateTime(new Date());
//        String s = obj2String(user);
//        log.info("s={}",s);
//        String s1 = obj2StringPretty(user);
//        log.info("s1={}",s1);
//
//        User user1=new User();
//        user1.setId(2);
//        user1.setUsername("宇智波鼬");
//        List<User> list=Lists.newArrayList();
//        list.add(user);
//        list.add(user1);
//        String s2 = obj2StringPretty(list);
//        log.info("s2={}",s2);
//
//        List<User> list1 = string2Obj(s2, new TypeReference<List<User>>() {
//        });
//        log.info("list1={}",list1);
//        List<User> list2 = string2Obj(s2, List.class, User.class);
